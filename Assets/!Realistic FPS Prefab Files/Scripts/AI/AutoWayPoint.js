...
public var waypointGroup : int = 0;//waypoint group number of this waypoint
public var waypointNumber : int = 0;//number of this waypoint in path sequence
//LayerMask for only letting world collision objects block waypoint line of sight 
private var capsuleMask : LayerMask = 10;

static function FindClosest (pos : Vector3, waypointsToFollow : int) : AutoWayPoint {
